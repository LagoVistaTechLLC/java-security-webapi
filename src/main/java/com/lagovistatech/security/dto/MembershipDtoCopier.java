...
public class MembershipDtoCopier {
	public void copy(MembershipDto source, Membership destination) {
	...
	public void copy(Membership source, MembershipDto destination) {
