...
public class SecurableActionRowFactoryImp<R extends SecurableActionRow> implements SecurableActionRowFactory<R> {
	protected SecurableActionRowFactoryImp() {}
	
	@SuppressWarnings("unchecked")
	public R create() { return (R) new SecurableActionRowImp(new HashMap<String, Object>()); }
