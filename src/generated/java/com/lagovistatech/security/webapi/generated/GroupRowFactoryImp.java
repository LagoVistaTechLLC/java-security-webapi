...
public class GroupRowFactoryImp<R extends GroupRow> implements GroupRowFactory<R> {
	protected GroupRowFactoryImp() {}
	
	@SuppressWarnings("unchecked")
	public R create() { return (R) new GroupRowImp(new HashMap<String, Object>()); }
