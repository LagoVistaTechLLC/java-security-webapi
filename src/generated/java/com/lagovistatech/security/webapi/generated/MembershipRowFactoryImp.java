...
public class MembershipRowFactoryImp<R extends MembershipRow> implements MembershipRowFactory<R> {
	protected MembershipRowFactoryImp() {}
	
	@SuppressWarnings("unchecked")
	public R create() { return (R) new MembershipRowImp(new HashMap<String, Object>()); }
